package com.shachar.coupons.tester;
...
import com.shachar.coupons.controller.CompanyController;
import com.shachar.coupons.controller.CouponController;
import com.shachar.coupons.controller.CustomerController;
import com.shachar.coupons.controller.PurchaseController;
import com.shachar.coupons.controller.UserController;
...
public class Tester {
	...
	public static void main(String[] args) throws Exception {
		...
		Coupon coupon = new Coupon( 280f, "fish meal", 45678l, 10,Date.valueOf("2020-10-18"),CouponscCategory.restaurant, Date.valueOf("2019-10-18"));
...
//		couponController.upDateCoupon(coupon1);
		...
		Customer customer = new Customer ("i@gmail.com",new String("Qwer124").hashCode(),UserType.customer,true, 2, Date.valueOf("1991-04-16"), "Modiin", "052848");		
		...
		Purchase purchase = new Purchase (Date.valueOf("2019-10-18"), 48,  (long) 17, 3 );
		...
		User user = new User("avi3211@gmail.com",new String("Qwer1234").hashCode(), (long) 67 ,  UserType.company);
